...
public class ApplicationConfig extends Application {
    ...
    private void addRestResourceClasses(Set<Class<?>> resources) {
        ...
        resources.add(co.edu.uniandes.csw.viajes.resources.EntretenimientoUbicacionResource.class);
        ...
        resources.add(co.edu.uniandes.csw.viajes.resources.HospedajeUbicacionResource.class);
